...
# (for bash shell)
bash $1/sourceme.bash #path/to/cellranger-6.0.1/sourceme.bash
# OR (for C shell)
#source path/to/cellranger-6.0.1/sourceme.csh
...
#path/to/cellranger-6.0.1/cellranger-cs/6.0.1/lib/bin/fetch-imgt
$1/lib/bin/fetch-imgt --genome $2 --species $3
